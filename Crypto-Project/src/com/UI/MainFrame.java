...
class MainPanel extends BackgroundPanel{
    public MainPanel() {
        ...
        add(newUserButton);
        RoundButton showBlocks = new RoundButton("View Blockchain", frameWidth - 320, 525, 220, 50, 25, Color.BLACK, Color.green, false);
        add(showBlocks);
        ...
        showBlocks.addActionListener(e -> {
            mainFrame.remove(framePanel);
            mainFrame.add(new BlockChain(medicalChain.blockchain));
            mainFrame.repaint();
        });
    }
